...
# Elementi principali:
  ...
  3. una specie di "ruota" contente i punti da poter guadagnare durante il turno
     ...
     3.1 bonus all'interno della ruota e gestione delle probabilita'
  5. stampa a video di una tastiera contente le lettere dell'alfabeto, colorando del colore opportuno quelle azzeccate/errate
  6. sistema di gestione dei crediti e negozio delle vocali
